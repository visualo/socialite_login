                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <a href="{{ url('auth/google') }}" class="btn btn-danger">Login with Gmail&ensp;&ensp;&ensp;</a>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                            <a href="{{url('/auth/redirect/twitter')}}" class="btn btn-info">Login with Twitter&ensp;&ensp;&ensp;</a>
                                </a>
                            </div>
                        </div>
